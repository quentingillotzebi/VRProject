...
namespace FLOW
{
	...
	[HelpURL(FlowHelper.HelpUrlPrefix + "FlowInputManager")]
	[AddComponentMenu(FlowHelper.ComponentMenuPrefix + "Input Manager")]
	public class FlowInputManager : MonoBehaviour
	{
		...
		public struct Trigger
		{
			...
			public bool WentDown(Finger finger)
			{
				...
				if (UseKey != KeyCode.None && finger.Index == HOVER_FINGER_INDEX && FlowInputManager.WentDown(UseKey) == true)
				{
					return true;
				}
			...
			public bool IsDown(Finger finger)
			{
				...
				if (UseKey != KeyCode.None && finger.Index == HOVER_FINGER_INDEX && FlowInputManager.IsDown(UseKey) == true)
				{
					return true;
				}
			...
			public bool WentUp(Finger finger, bool useAnyFinger = false)
			{
				...
				if (UseKey != KeyCode.None && finger.Index == HOVER_FINGER_INDEX && FlowInputManager.WentUp(UseKey) == true)
				{
					return true;
				}
		...
		{
			if (Application.isPlaying == true && FindObjectOfType<FlowInputManager>() == null)
			{
				new GameObject(typeof(FlowInputManager).Name).AddComponent<FlowInputManager>();
			}
		}
